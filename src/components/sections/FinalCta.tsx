...
export function FinalCta() {
  return (
    <Section id="contact" spacing="base" className="border-t border-ink-600">
      <Container>
        <div className="flex flex-col items-start">
          ...
          <SplitText
            ...
            gap={0.07}
            className="mt-4 text-[clamp(2.5rem,7.5vw,5.5rem)] leading-[0.94] tracking-[-0.02em]"
          />

          <Reveal delay={0.12}>
            <p className="mt-6 max-w-[48ch] text-lg text-bone-muted">
